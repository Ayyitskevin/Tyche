...
export const DEFAULT_COMMANDS: RegisteredCommand[] = [
  ...
  cmd({
    id: 'MULT',
    aliases: ['MULTIPLES', 'VALH'],
    title: 'Valuation multiples',
    description: 'Trailing P/E and P/S by fiscal year + current, with the historical range. Descriptive, not advice.',
    category: 'analytics',
    moduleId: 'valuation',
    defaultPanelSize: { w: 6, h: 14 },
    maturity: 'stable',
