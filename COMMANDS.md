...
| `EQS`   | `SCREEN`, `SCREENER` | screener      |      | `screener`                   | Equity screener — filter/sort the universe by price/%chg/mktcap/volume/sector plus forensic **Altman Z′** (distress) and **Piotroski F** (quality) scores derived from filings |
